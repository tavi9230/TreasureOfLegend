...
import { Wall } from 'TBRPG/Objects/wall';
import { Floor } from 'TBRPG/Objects/floor';
	...
	this.generate = function () {
		...
		for (var x = 0, i = 0; i < rows; x += 100, i++) {
			...
			for (var y = 0, j = 0; j < columns; y += 100, j++) {
				//ctx.rect(x, y, 40, 40);
				ctx.drawImage(this.images[1], 64, 128, 16, 16, x, y, 100, 100);
				this.objects.floor.push(new Floor(100, 0, this.images, 100, 100, 100, 100));
			}
			//ctx.closePath();
		}
